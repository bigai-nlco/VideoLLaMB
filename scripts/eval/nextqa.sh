...
CKPT_NAME="llava-7b-ft-rmtr1x-lvcn_16_8_pool12_next"
...
output_dir="${GPT_Zero_Shot_QA}/NExT_Zero_Shot_QA/${CKPT_NAME}"
NUM_FRAMES=8
...
python scripts/eval_nextqa.py --src $output_file --dst $GQADIR/subset.json
