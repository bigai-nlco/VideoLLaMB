...
conv_mode = "llava_v1"
model_path = 'checkpoints/videollamb-llava-1.5-7b'
cache_dir = './cache_dir'
device = 'cuda'
load_8bit = True
load_4bit = False
...
with gr.Blocks(title='VideoLLaMB', theme=gr.themes.Default(), css=block_css) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=7):
            chatbot = gr.Chatbot(label="VideoLLaMB", bubble_full_width=True)
            with gr.Row():
