...
class VideoMAEVisionTower(nn.Module):
    def __init__(self, video_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = VideoMAEConfig.from_pretrained(self.video_tower_name)
    ...
    def load_model(self, device_map=None):
        ...
        self.video_processor = VideoMAEImageProcessor.from_pretrained(self.video_tower_name)
        # self.video_tower = VideoMAEModel.from_pretrained(self.video_tower_name, device_map=device_map)
        self.video_tower = VideoMAEModel.from_pretrained(self.video_tower_name)
    ...
    def feature_select(self, image_forward_outs):
        ...
        if self.select_feature == 'patch':
            ...
            raise ValueError(f"Unimplemented select feature: {self.select_feature}")
