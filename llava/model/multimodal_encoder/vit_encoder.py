...
class ViTVisionTower(nn.Module):
    def __init__(self, image_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = ViTConfig.from_pretrained(self.image_tower_name)
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = ViTImageProcessor.from_pretrained(self.image_tower_name)
        # self.image_tower = ViTModel.from_pretrained(self.image_tower_name, device_map=device_map)
        self.image_tower = ViTModel.from_pretrained(self.image_tower_name)
