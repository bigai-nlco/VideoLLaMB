...
def run_inference(args):
    ...
    gt_questions = json.load(open(args.gt_file, "r"))
    ...
    for sample in tqdm(gt_questions):
        ...
        # # construct prompt
        # pre_prompt = "The input consists of a sequence of key frames from a video. Answer the question concisely first and followed by significant events, characters, or objects that appear throughout the frames. Question:"
        # question_1 = f"{pre_prompt} {question_1}\n"
        # question_2 = f"{pre_prompt} {question_2}\n"
