...
def run_inference(args):
    ...
    index = 0
    for samples in tqdm(gt_questions):
        
        key_video_name = samples['video_name']


        # global:
        for sample in samples["global"]:
        ...
        for sample in samples["breakpoint"]:
        ...
        ans_file.write(json.dumps({
            f"{key_video_name}.mp4": {
                "global": samples["global"],
                "breakpoint": samples["breakpoint"],
            }
        })+"\n")
